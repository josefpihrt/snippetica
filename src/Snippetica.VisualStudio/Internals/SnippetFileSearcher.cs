...
/// </summary>
internal static class SnippetFileSearcher
{
    /// <summary>
    ...
    public static IEnumerable<string> EnumerateSnippetFiles(IEnumerable<string> directoryPaths, SearchOption searchOption = SearchOption.TopDirectoryOnly)
    {
    ...
    public static IEnumerable<string> EnumerateSnippetFiles(string directoryPath, SearchOption searchOption = SearchOption.TopDirectoryOnly)
    {
