...
- Add snippet for 'switch expression' (`swe`) ([#34](https://github.com/josefpihrt/snippetica/pull/34)).
...
- Change shortcut for 'switch statement' from `sh` to `sw` ([#35](https://github.com/josefpihrt/snippetica/pull/35)), ([#38](https://github.com/josefpihrt/snippetica/pull/38)).
- Change shortcut for 'enum' from `em` to `en` ([#31](https://github.com/josefpihrt/snippetica/pull/31)).
...
- Change shortcut for 'event declaration' from `et` to `ev` ([#42](https://github.com/josefpihrt/snippetica/pull/42)).
- Change shortcut for 'throw statement' from `tw` to `th` ([#41](https://github.com/josefpihrt/snippetica/pull/41)).
