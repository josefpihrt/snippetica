...
& "../src/Tools/Snippetica.CodeGeneration.SnippetGenerator/bin/Release/net6.0/Snippetica.CodeGeneration.SnippetGenerator" "../src" "../src/Snippetica.CodeGeneration.Metadata/data"
